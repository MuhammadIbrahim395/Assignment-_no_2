...
let personName = "\t Muhammad Ibrahim \n";
...
let a = "i don't have time to do your homework"; //in this line i give you my comment.
let b = a.split(" "); // in this way i convert each word into string in an array.
a = b.join(" "); // in this way i again convet it into string.
console.log(a);
let electricityBill = 0; // in the begining of the day 0f the month the units are.
for (let i = 0; i < 30; i++) {
...
let names = ["Hasseb", "Moaz", "Usama", "Ahmad"];
for (let i = 0; i < names.length; i++) {
    console.log(names[i]);
}
console.log("Q no 12");
//Greetings: Start with the array you used in Exercise 11, but instead of just printing each person’s name, print a message to them. The text of each message should be the same, but each message should be personalized with the person’s name.
let friendsNames = ["Hasseb", "Moaz", "Usama", "Ahmad"];
for (let i = 0; i < names.length; i++) {
    console.log("Hello my friend", names[i]);
}
console.log("Q no 13");
// //Your Own Array: Think of your favorite mode of transportation, such as a motorcycle or a car, and make a list that stores several examples. Use your list to print a series of statements about these items, such as “I would like to own a Honda motorcycle.
let list = ["Civic Honda car.", "Changan company car.", "Yaris car.", " Fortuner car.", "Suzuki Wagon R."];
...
let places = ["Al Makkah Mukarma", "Madina Munarwa", "Istanbul", "Toronto", "Niagra falls", "Belgium"];
...
let countries = ["Germany", "Spain", "Pakistan", "Nepal", "India", "Canada",];
...
let personObject1 = Object.assign({}, personObject);
console.log(personObject1);
console.log(personObject);
console.log("Q no 22");
// //Intentional Error: If you haven’t received an array index error in one of your programs yet, try to make one happen. Change an index in one of your programs to produce an index error. Make sure you correct the error before closing the program.
let cities = ["Faisalabad", "Lahore", "Multan", "Islamabad", "Sialkot"];
...
let age = 19;
let haslisense = false;
let hasmotorcycle = true;
console.log("Q no 1");
console.log("age > 18");
console.log(age > 18);
console.log("Q no 2");
...
let usernames = ["eric", "harry", "ibrahim", "admin", "usama"];
